          ...
          <Form {...form}>
            <form className="flex flex-col gap-3" onSubmit={form.handleSubmit(onSubmit)}>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">Full Name <RequiredAsterisk /></FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">Confirm Password <RequiredAsterisk /></FormLabel>
                    <FormControl>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col items-start gap-1">
                    <div className="flex flex-row flex-wrap items-center gap-2 w-full">
                      ...
                      <FormLabel htmlFor="termsAndConditions" className="text-sm font-medium select-none cursor-pointer">
                        I agree to the <a href="#" className="text-blue-600">Terms of Service</a> and <a href="#" className="text-blue-600">Privacy Policy</a> <RequiredAsterisk />
                      </FormLabel>
                    </div>
                    <FormMessage />
                  </FormItem>
