		...
		<>
            ...
            {!isImported ? (
                <div className="border flex gap-4 p-2">
                    <div className=" w-2/5">
                        ...
                        <div className="flex gap-4 justify-between w-full">
                            <h2 className="text-lg w-full font-semibold mb-4 text-foreground">Import data</h2>
                            {excelData.length > 0 && (
                ...
                <div className=" flex justify-center">
                    <div className=" w-1/2">
                        <CardWrapper className=" mt-2 shadow-md border border-muted rounded-2xl ">
                            <div className="font-medium text-xl">Dataset name</div>
                            <div className=" text-sm text-zinc-500">This dataset will be used as external logic 
                                reference for the system to understand the underlying factors that contributed to the
                                predicted results.
                            </div>
                            <div className="mt-4">
                                <div className="text-sm"></div>
                                <input type="text" name="" id=""
                                    className=' border w-full p-2 rounded-sm' placeholder='Start typing...'
                                    onChange={(e)=>{setDataset_name(e.value)}}
                                />
                            </div>
                            ...
                            <div className=" flex justify-end mt-4">
                                {saving ? (
                                    <div className="flex">
                                        <div className="flex items-center gap-2 mr-1 text-white">
                                            <svg className="animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                <circle className="opacity-45" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                                                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z" />
                                            </svg>
                                    ...
                                    <div onClick={()=>saveDataset()} className=" text-lg text-white font-medium bg-blue-500 hover:bg-blue-700 transition-all active:scale-95 p-1 px-4 rounded-sm cursor-pointer ">Save</div>
                                )}
                            </div>
                        </CardWrapper>
                    </div>
